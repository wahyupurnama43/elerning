    ...
    <div class="col-md-12 col-xs-12">
      <div class="alert alert-info alert-dismissible" role="alert">
        ...
        <ul>
          ...
          <li>Untuk memantau siswa yang sedang mengikuti ulangan, anda bisa memilih tombol berwarna kuning pada kolom status ulangan</li>
        </ul>
      </div>
      <div class="card">
        <div class="card-body">
            ...
            <table class="table table-striped table-hover table-condensed" id="data">
              ...
              <tbody>
                ...
                $sqlrole  = mysqli_query($con, "SELECT * FROM ujian
                    ...
                    WHERE tb_roleguru.id_guru  = '$sesi' AND ujian.tanggal >= '$hariLocal' AND ujian.jam_selesai >= '$jamLocal'  ORDER BY id_ujian DESC");
                            ...
                            <div class="modal-content">
                              <div class="modal-header">
                                <h4 class="modal-title">
                                  <center>
                                    Apakah Anda Ingin <b>Non Aktifkan</b> Ulangan Ini <br> Sekarang ?
                                  </center>
                                </h4>
                              </div>
