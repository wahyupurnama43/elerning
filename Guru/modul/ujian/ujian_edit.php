                ...
                <form class="forms-sample" action="?page=proses" method="post" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                    ...
                    <select class="form-control" id="kategori" name="kategori" style="font-weight: bold;background-color: #212121;color: #fff;" required>
                      ...
                      <option value='pilgan' <?php if($d['kategori'] == 'pilgan') { echo 'selected';} ?>>Pilihan Ganda</option>
                      <option value='essay' <?php if($d['kategori'] == 'essay') { echo 'selected';} ?>>Essay</option>
                    </select>
                  </div>
                  <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                    <select class="form-control" name="acak" style="font-weight: bold;background-color: #212121;color: #fff;" required>
                      ...
                      <option value="acak" <?php if($d['acak'] == 'acak') { echo 'selected';} ?>>Acak Soal</option>
                      <option value="tidak" <?php if($d['acak'] == 'tidak') { echo 'selected';} ?>>Tidak Acak</option>
                    </select>
                </div>
                <hr>
