        ...
        <div class="card-body">
          <form action="?page=proses" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
              ...
              <input type="text" id="nama" name="nmsekolah" class="form-control" value="<?php echo $d['nama_sekolah']; ?>" required>
            </div>
              <div class="form-group">
              <label for="kepsek">Nama Kepala Sekolah</label>
              <input type="text" id="kepsek" name="kepsek" class="form-control" value="<?php echo $d['kepsek']; ?>" required>
            </div>
              <div class="form-group">
              <label for="copyright">Copyright</label>
              <input type="text" id="copyright" name="copyright" class="form-control" value="<?php echo $d['copyright']; ?>" required>
            </div>
                <div class="form-group">
