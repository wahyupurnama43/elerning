<div class="content-wrapper">
  <h4> <b>Master</b> <small class="text-muted">/ mapel</small></h4>
  <hr>
  <div class="row">
    <div class="col-md-10">
      <div class="card">
        <div class="card-body">
          <p class="card-description">
            <a data-toggle="modal" data-target="#add" class="btn btn-info text-white pull-right"><i class="fa fa-plus"></i> Tambah mapel</a> <br>
          </p>
                  ...
                  foreach ($sql as $d) { ?>
                    <tr>
                      ...
                      <td class="text-center">
                                ...
                                <form action="" method="post">
                                  <div class="modal-body">
                                    <div class="form-group">
                                      ...
                                      <input type="text" id="mapel" name="mapel" class="form-control" value="<?=$d['mapel']?>" required>  
                                    </div>
                                  </div>
                                      ...
                                      echo "
                                        <script type='text/javascript'>
                                          ...
                                          window.setTimeout(function(){ 
                                            window.location.replace('?page=mapel&alert=Data berhasil diedit');
                                          } ,3000);   
                                        </script>";                       
                                    }                   
                                  }
                        ...
                        <button type="button" class="btn btn-danger btn-xs" data-toggle="modal" data-target="#hapus<?=$d['id_mapel']?>"><i class="fa fa-trash"></i> Hapus</button>

                        <!-- Modal -->
                        <div class="modal fade" id="hapus<?=$d['id_mapel']?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                          <div class="modal-dialog" role="document">
                            <div class="modal-content">
                              ...
                              <div class="modal-body">
                                Apakah anda yakin akan menghapus data mata pelajaran ini?
                              </div>
                              <div class="modal-footer">
                                <button type="button" class="btn btn-secondary" data-dismiss="modal">Tutup</button>
                                <a href="?page=mapel&act=del&id=<?=$d['id_mapel']?>" class="btn btn-danger"><i class="fa fa-trash"></i> Hapus</a>
                              </div>
                            </div>
                          </div>
                        </div>
        ...
        <form action="" method="post">
          <div class="modal-body">
            <div class="form-group">
              ...
              <input type="text" id="mapel" name="mapel" class="form-control" placeholder="Nama Mata Pelajaran" required>                    
            </div>
          </div>
          <div class="modal-footer">
            <button type="button" class="btn btn-default" data-dismiss="modal">Batal</button>
            ...
            if ($sql) {
                echo "
                  <script type='text/javascript'>
                    ...
                    window.setTimeout(function(){ 
                      window.location.replace('?page=mapel&alert=Data berhasil ditambah');
                    } ,3000);   
                  </script>";                        
            }                   
          }
