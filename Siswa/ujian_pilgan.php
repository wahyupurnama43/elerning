...
if (mysqli_num_rows($qnilai) < 1) {
  ...
  $data = mysqli_query($mysqli, "INSERT INTO nilai SET id_siswa='$_SESSION[id_siswa]',id_ujian='$_GET[ujian]', acak_soal='$acak_soal', jawaban='$jawaban', sisa_waktu='$waktu',waktu_selesai='$waktuselesai'");
...
for ($s = 0; $s < count($arr_soal); $s++) {
  ...
  if ($rsoal['gambar'] !== null || !empty($rsoal['gambar'])) {
    $gambar_soal = '<img src="../vendor/images/img_Soal/' . $rsoal['gambar'] . '" width="300px" height="300px">';
  } else {
    $gambar_soal = '';
  }
  echo ' <div id="picture">
