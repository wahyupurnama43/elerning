        ...
        <div class="navbar-menu-wrapper d-flex align-items-center">
          ...
          <ul class="navbar-nav navbar-nav-right">
            ...
            $chat = mysqli_query($con, "SELECT * FROM chat 
                                        INNER JOIN tb_roleguru ON chat.id_roleguru = tb_roleguru.id_roleguru
                                        INNER JOIN tb_master_mapel ON tb_master_mapel.id_mapel = tb_roleguru.id_mapel WHERE waktu_selesai > $waktu ");

            $jumlahChat = mysqli_num_rows($chat);

            $jumlahNotifikasi = $jmlh + $jumlahTugas + $jumlahPengumuman + $jumlahChat;
            ?>
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="notificationDropdown">
                ...
                <a href="?page=chat" class="dropdown-item">
                  <p class="mb-0 font-weight-normal float-left"><b><?= $jumlahChat; ?></b> Chat |
