<?php 
  ...
  foreach ($intriksi as $d) ?>
    <div class="content-wrapper">
      <h4> <b>TUGAS</b> <small class="text-muted">/<?php echo $_GET['jenis']; ?></small></h4>
      <hr>
      <div class="row">
        <div class="col-md-8">
          <div class="card">
            <div class="card-body">
              <h6 class="card-title" style="font-weight: bold;"><br></h6> 
              <table class="table">
                <tr>
                  <th>JENIS TUGAS</th>
                  <th>:</th>
                ...
                if ($_GET['id']==1) {
                  ...
                  <form action="?page=proses" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      ...
                      <textarea name="subjek" class="form-control" rows="4"></textarea>			
                    </div>
                    <div class="form-group">
                        ...
                        <tr>
                          ...
                          <tr>
                            ...
                            <td>
                              ...
                              $sekelas = mysqli_query($con,"SELECT * FROM tb_siswa WHERE id_kelas='$_SESSION[kelas]'");
